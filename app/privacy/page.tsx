  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      >
        ...
        <p>
          At Quotica, we take your privacy seriously. This Privacy Policy
        ...
        <ul className="list-disc pl-6 mb-6">
          <li>
            <strong>Personal Data:</strong> When you register or use our
            services, we may collect your email address, name, and other
            information you provide.
          </li>
          <li>
            <strong>Usage Data:</strong> We automatically collect information
            about how you interact with our service, including the pages you
        ...
        <ul className="list-disc pl-6 mb-6">
          <li>
            <strong>Service Providers:</strong> Third-party companies who assist
        ...
        <p>
          ...
          information. However, no electronic transmission or storage system is
        ...
        <p>
          ...
          at{" "}
          <a
            href="mailto:privacy@quotica.app"
